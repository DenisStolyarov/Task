...
{
    internal class AsynchronousProgrammingModel
    {
            ...
            object state)
        {
            ...
            var ar = new CustomAsyncResult(state);
        ...
        {
            if (asyncResult is not CustomAsyncResult ar)
            {
        ...
        private sealed class CustomAsyncResult : IAsyncResult
        {
            ...
            public CustomAsyncResult(object? state) => AsyncState = state;
